...
export const GAS_SCRIPT_URL = import.meta.env.VITE_GAS_SCRIPT_URL || 'https://script.google.com/macros/s/AKfycbz1uuh3hZRl9aLVWsGe42oGFfACM-YYKhAaDlQl6OwCFD19xYXaZh0Mff1X5_IpYnHViA/exec';
